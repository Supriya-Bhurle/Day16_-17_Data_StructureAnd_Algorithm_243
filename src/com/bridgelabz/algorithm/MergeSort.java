...
public class MergeSort {
   ...
   /* MergeSort :- sorting algorithm that works by dividing an array into smaller subarrays, sorting each subarray,
    and then merging the sorted subarrays back together to form the final sorted array.
    */
    public static void main(String[] args) {
        String[] arr = {"Supriya", "Ajay", "shivani", "Mansi", "Surabhi", "Akshay", "Abhijit"};
        System.out.println();
